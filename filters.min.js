...
addPositiveKeyword: function(parent, h){
		...
		"			</div>"+
		"			<div class='span4'>"+
		"				<button id='btnKeywordI' class='include-button btn btn-mini btn-blue' type='button' onclick='addKeyword(true)' disabled><i class='icon-plus' tabindex='-1'></i> Include</button>"+
		"				<button id='btnKeywordE' class='exclude-button btn btn-mini btn-red' type='button' onclick='addKeyword(false)' disabled><i class='icon-minus' tabindex='-1'></i> Exclude</button>"+
		"			</div>"+
		"		</div>"+
...
getNegativeKeywords: function(parent){
	...
	//alert($('.label-important').text());
},


removeKeyword: function(parent,h){
	//alert(h);
	$("span:contains("+h+")").remove();
...
draw: function(parent, h) {
		...
		if(h['allowed_values'].length==0){
			alert("no data");
		}
		else{
			//alert(h['allowed_values'].length);

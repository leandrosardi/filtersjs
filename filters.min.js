filtersJs = {
    ...
    addKeyword: function(parent, isPositive) {
        ...
        s = '<span class="label ' + sClass + '" valign="middle" value="' + input.value + '">' +
            "<a href='javascript:void(0)' onclick='filtersJs.removeKeyword(document.getElementById(\""+parent.id+"\"), \""+input.value+"\");' class='close' data-dismiss='alert'> <i class='icon-remove-sign'></i></a> " + input.value + " " +
            "</span> "
